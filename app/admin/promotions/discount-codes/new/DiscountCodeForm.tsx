    ...
    <div className="max-w-2xl">
      ...
      >
        ...
        <div>
          ...
          />
          <p className="text-xs text-text-muted mt-1">
            Maximum number of times this code can be used before it's exhausted
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p className="text-xs text-text-muted mt-1">
            Leave empty to never expire. Code automatically deactivates after this date.
          </p>
        </div>
        ...
        <div className="bg-bg-elevated rounded-lg p-4 border border-border-subtle">
          ...
          <div className="flex items-baseline gap-2">
            <code className="font-dm-mono text-lg font-bold text-accent">
              {formData.code || "CODE"}
            </code>
